...
/** \brief Função responsável por testar a conversão de valores divisíveis por 10.*/
TEST(CONVERTE_ROMANO, CONVERSAO_INTEIRA) { 
    EXPECT_EQ (30, CONVERTE_ROMANO("XXX"));
    EXPECT_EQ (1700, CONVERTE_ROMANO("MDCC"));
    EXPECT_EQ (60, CONVERTE_ROMANO("LX"));
    EXPECT_EQ (40, CONVERTE_ROMANO("XL"));
    EXPECT_EQ (1500, CONVERTE_ROMANO("MD"));
